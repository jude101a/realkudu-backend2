...
// import {FIELD_MAP} from "./gen.property.model.js";
...
//   const conditions = ["deleted_at IS NULL","status = 'available'"];
//   const values = [];
//   let idx = startIndex;
...
//   if (filters.q) {
//     conditions.push(
//       `(address ILIKE $${idx} OR description ILIKE $${idx} OR house_name ILIKE $${idx})`
//     );
...
//     const rents = rows.map((r) => Number(r.price) || 0);
