...
const endpoints = [
  ...
  { method: "GET", path: "/api/estates/estates/deleted/{sellerId}", tag: "Estates Admin", summary: "Get deleted estates by seller", auth: true },

  { method: "GET", path: "/api/houses", tag: "Houses", summary: "List houses" },
  { method: "GET", path: "/api/houses/getAllHouses", tag: "Houses", summary: "List houses" },
  ...
  { method: "POST", path: "/api/houses/createHouse", tag: "Houses", summary: "Create house", auth: true, body: true },
  { method: "PUT", path: "/api/houses/{id}/cover", tag: "Houses", summary: "Update house cover", auth: true, body: true },
  { method: "PUT", path: "/api/houses/{id}/coverImage", tag: "Houses", summary: "Update house cover", auth: true, body: true },
  { method: "PUT", path: "/api/houses/{id}/lawyer", tag: "Houses", summary: "Update house lawyer", auth: true, body: true },
  { method: "PUT", path: "/api/houses/{id}/updateHouseLawyer", tag: "Houses", summary: "Update house lawyer", auth: true, body: true },
  { method: "PUT", path: "/api/houses/{id}/caretaker", tag: "Houses", summary: "Update house caretaker", auth: true, body: true },
  { method: "PUT", path: "/api/houses/{id}/updateHouseCaretaker", tag: "Houses", summary: "Update house caretaker", auth: true, body: true },
  { method: "PUT", path: "/api/houses/softDeleteHouse/{id}", tag: "Houses", summary: "Soft delete house", auth: true, body: true },
  { method: "PUT", path: "/api/houses/{id}", tag: "Houses", summary: "Update house", auth: true, body: true },
  { method: "PUT", path: "/api/houses/updateHouse/{id}", tag: "Houses", summary: "Update house", auth: true, body: true },
  { method: "DELETE", path: "/api/houses/{id}", tag: "Houses Admin", summary: "Delete house", auth: true },
  { method: "DELETE", path: "/api/houses/deleteHouse/{id}", tag: "Houses Admin", summary: "Delete house", auth: true },
  ...
  { method: "GET", path: "/api/properties/{propertyId}/images", tag: "Properties", summary: "Get property images" },
  ...
  { method: "POST", path: "/api/properties/create", tag: "Properties", summary: "Create property", auth: true, body: true },
  ...
  { method: "GET", path: "/api/images/property/{propertyId}", tag: "Images", summary: "Get property images" },
  ...
  { method: "POST", path: "/api/admin/owner/bootstrap", tag: "Admin", summary: "Bootstrap first admin owner", body: true },
  { method: "GET", path: "/api/admin/users", tag: "Admin", summary: "List admin users", auth: true },
  { method: "GET", path: "/api/admin/users/{userId}", tag: "Admin", summary: "Get admin user details", auth: true },
  { method: "GET", path: "/api/admin/stats", tag: "Admin", summary: "Get admin stats", auth: true },
  { method: "GET", path: "/api/admin/traffic", tag: "Admin", summary: "Get traffic stats", auth: true },
  { method: "GET", path: "/api/admin/financial-stats", tag: "Admin", summary: "Get financial stats", auth: true },
  { method: "GET", path: "/api/admin/api-stats", tag: "Admin", summary: "Get API stats", auth: true },
  { method: "GET", path: "/api/admin/transactions", tag: "Admin", summary: "List transactions", auth: true },
  { method: "GET", path: "/api/admin/transactions/{transactionId}", tag: "Admin", summary: "Get transaction details", auth: true },
  { method: "GET", path: "/api/admin/accounts", tag: "Admin", summary: "List staff accounts", auth: true },
  { method: "POST", path: "/api/admin/accounts", tag: "Admin", summary: "Create staff account", auth: true, body: true },
  { method: "GET", path: "/api/admin/stakeholders", tag: "Admin", summary: "List stakeholders", auth: true },
  { method: "POST", path: "/api/admin/stakeholders", tag: "Admin", summary: "Create stakeholder", auth: true, body: true },
  { method: "PATCH", path: "/api/admin/stakeholders/{userId}", tag: "Admin", summary: "Update stakeholder", auth: true, body: true },
  { method: "PATCH", path: "/api/admin/stakeholders/{userId}/password", tag: "Admin", summary: "Reset stakeholder password", auth: true, body: true },
  { method: "PATCH", path: "/api/admin/stakeholders/{userId}/status", tag: "Admin", summary: "Update stakeholder status", auth: true, body: true },
  { method: "PATCH", path: "/api/admin/me/password", tag: "Admin", summary: "Update own password", auth: true, body: true },
  { method: "GET", path: "/api/admin/activity-logs", tag: "Admin", summary: "List activity logs", auth: true },
  { method: "POST", path: "/api/admin/listings/{propertyId}/approve", tag: "Admin", summary: "Approve listing", auth: true },
  { method: "POST", path: "/api/admin/listings/{propertyId}/reject", tag: "Admin", summary: "Reject listing", auth: true, body: true },
  { method: "POST", path: "/api/admin/sellers/{sellerId}/kyc/approve", tag: "Admin", summary: "Approve seller KYC", auth: true },
  { method: "POST", path: "/api/admin/sellers/{sellerId}/kyc/reject", tag: "Admin", summary: "Reject seller KYC", auth: true, body: true },

  { method: "POST", path: "/api/payments/initialize", tag: "Payments", summary: "Initialize payment", auth: true, body: true },
  { method: "GET", path: "/api/payments/verify/{reference}", tag: "Payments", summary: "Verify payment" },
  { method: "GET", path: "/api/payments/history", tag: "Payments", summary: "Payment history", auth: true },
  { method: "GET", path: "/api/payments/{reference}", tag: "Payments", summary: "Get payment transaction", auth: true },
  { method: "POST", path: "/api/payments/refund", tag: "Payments", summary: "Refund payment", auth: true, body: true },
  { method: "POST", path: "/api/payments/recipient", tag: "Payments", summary: "Create transfer recipient", auth: true, body: true },

  { method: "POST", path: "/api/transfers", tag: "Transfers", summary: "Initiate transfer", auth: true, body: true },
  { method: "GET", path: "/api/transfers/status/{reference}", tag: "Transfers", summary: "Get transfer status", auth: true },
  { method: "GET", path: "/api/transfers/seller/{sellerId}", tag: "Transfers", summary: "List seller transfers", auth: true },

  { method: "GET", path: "/api/wallet", tag: "Wallet", summary: "Get seller wallet", auth: true },

  { method: "GET", path: "/api/tenants/by-tenant", tag: "Tenants", summary: "Get tenant meta by tenant" },
  { method: "GET", path: "/api/tenants/by-property", tag: "Tenants", summary: "Get tenant meta by property" },
  { method: "POST", path: "/api/tenants", tag: "Tenants", summary: "Create tenant meta", auth: true, body: true },
  { method: "PUT", path: "/api/tenants/{tenantMetaId}/mark-rent-paid", tag: "Tenants", summary: "Mark rent paid", auth: true, body: true },
  { method: "PUT", path: "/api/tenants/{tenantMetaId}/outstanding-balance", tag: "Tenants", summary: "Update outstanding balance", auth: true, body: true },
  { method: "POST", path: "/api/tenants/{tenantMetaId}/serve-notice", tag: "Tenants", summary: "Serve notice", auth: true, body: true },
  { method: "POST", path: "/api/tenants/{tenantMetaId}/terminate", tag: "Tenants", summary: "Terminate tenancy", auth: true, body: true },
  { method: "DELETE", path: "/api/tenants/{tenantMetaId}", tag: "Tenants", summary: "Delete tenant meta", auth: true },

  { method: "POST", path: "/api/webhooks/paystack", tag: "Webhooks", summary: "Paystack webhook" },
];
